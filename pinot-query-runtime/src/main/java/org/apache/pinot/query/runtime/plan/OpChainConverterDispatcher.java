...
public final class OpChainConverterDispatcher {
  ...
  public static OpChain convert(PlanNode node, OpChainExecutionContext context,
    ...
    OpChainConverter active = ACTIVE;
    // Inline the stock Java path when the active binding is the default converter
    if (active instanceof OpChainConverter.DefaultOpChainConverter) {
