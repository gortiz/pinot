...
public class UpsertRunner {
  ...
  public static void main(String[] args) throws Exception {
    ...
    PartitionUpsertOffHeapMetadataManager partitionUpsertOffHeapMetadataManager = new PartitionUpsertOffHeapMetadataManager(TABLE_NAME, 0, null, null, HashFunction.NONE);
    ...
    for (int i = 0; i < _numSegments; i++) {
      ...
      buildSegment(name);
      ImmutableSegmentImpl immutableSegment = (ImmutableSegmentImpl) ImmutableSegmentLoader.load(new File(INDEX_DIR, name), indexLoadingConfig);
...
//    }
  ...
  private static void buildSegment(String segmentName)
      throws Exception {
