...
public class BenchmarkUpsertNoPrecomputeSingleShot {
  ...
  private final int _numRuns = 1000;
  ...
  private String _scenario = "UNIFORM(0, 1000000000)";
...
//      e.printStackTrace();
  ...
  private List<GenericRow> createTestData(int numRows) {
    ...
    String[] lowCardinalityValues = IntStream.range(0, (int) _keyCardinality/_numRuns).mapToObj(i -> StringUtils.leftPad(String.valueOf(i), _keyStringLength, '1'))
        .toArray(String[]::new);
  ...
  private List<GenericRow> buildSegment(String segmentName)
      throws Exception {
    List<GenericRow> rows = createTestData(_numRowsPerSegment / _numRuns);
