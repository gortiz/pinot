...
/// The object used to return results from the UDF test execution framework.
///
...
public class UdfTestResult {
  ...
  private UdfTestResult(Udf suite, UdfExample test,
  ...
  public static UdfTestResult success(
      Udf suite,
      UdfExample test,
      @Nullable Object actualResult,
      @Nullable Object expectedResult) {
    return new UdfTestResult(suite, test, actualResult, expectedResult, null);
  }

  /// Creates a test result indicating an error in the test execution.
  public static UdfTestResult error(Udf suite, UdfExample test, String errorMessage) {
    return new UdfTestResult(suite, test, null, null, errorMessage);
  }
